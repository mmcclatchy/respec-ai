-- Fix phase ID to use model's generated ID instead of database auto-increment
...
-- Record migration
INSERT INTO schema_migrations (version, description) VALUES (4, 'Change phase ID from SERIAL to VARCHAR for model-generated IDs');
