...
def _generate_realistic_content(field_name: str) -> str:
    realistic_defaults = {
        ...
        'phase_status': 'draft',
        'shape_gate': 'unshaped',
        'module_layout': '- src/example/module.py — owns example responsibility',
        'skeleton_index': '- src/example/module.py :: ExampleClass.method(arg: str) -> None',
        'collaboration_and_wiring': 'ExampleService constructs ExampleClass at startup',
        'test_list': '- test_example_behavior',
        'open_design_decisions': 'OD-1: example open decision',
        'settled_design_decisions': 'SD-1: example settled decision (source=architect)',
        'plan_status': 'draft',
