from src.platform.templates.commands.build_command import generate_build_command_template
...
from src.platform.templates.commands.spec_command import generate_spec_command_template
