        ...
        async with db_pool.acquire() as conn:
            await conn.execute(
                ...
                INSERT INTO plans (
                    ...
                    included_features, anti_requirements, project_assumptions, project_constraints,
                    project_sponsor, key_stakeholders, end_users,
                    architecture_overview, data_flow, technology_decisions, technology_rejections,
                    ...
                    quality_bar, testing_strategy, acceptance_criteria,
                ...
                ON CONFLICT (plan_name) DO UPDATE SET
                    ...
                    included_features = $9, anti_requirements = $10, project_assumptions = $11, project_constraints = $12,
                    project_sponsor = $13, key_stakeholders = $14, end_users = $15,
                    architecture_overview = $16, data_flow = $17, technology_decisions = $18, technology_rejections = $19,
                    work_breakdown = $20, phases_overview = $21, project_dependencies = $22,
                    team_structure = $23, technology_requirements = $24, infrastructure_needs = $25,
                    identified_risks = $26, mitigation_strategies = $27, contingency_plans = $28,
                    quality_bar = $29, testing_strategy = $30, acceptance_criteria = $31,
                    plan_status = $32, additional_sections = $33, updated_at = CURRENT_TIMESTAMP
                """,
                plan_name,
                plan.project_vision,
    ...
    async def get_plan(self, plan_name: str) -> Plan:
        async with db_pool.acquire() as conn:
            ...
            return Plan(
                ...
                anti_requirements=row['anti_requirements'],
                ...
                technology_rejections=row['technology_rejections'],
