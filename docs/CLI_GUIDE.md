...
**For detailed workflow documentation, see [Workflows Guide](WORKFLOWS.md)**
...
**See [Workflows Guide](WORKFLOWS.md) for detailed documentation on each workflow, examples, and best practices.**
